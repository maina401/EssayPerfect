...
class ezcLog
{
     ...
     */
     ...
     /**
      * Notifications severity constant.
      */
     const NOTICE         = 16;
     ...
     * </code>
     *
     * Notifications that the ezcLog component is not loaded at all when the logging is disabled.
     *
     * @param int $errno
     * @param int $errstr
    ...
    public static function translateSeverityName( $severity )
    {
        switch ( $severity )
        {
            ...
            case self::NOTICE:          return "Notifications";
