...
<head>
        ...
        <title>Writer Dashboard | My Results</title>
...
<!--   <?php //if ($_COOKIE['lgist'] == "2") { print 'onload="myFunction()"'; } ?> -->
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small><?php echo $_SERVER['SERVER_NAME'];?> writer</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
