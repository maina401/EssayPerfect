...
<head>
        ...
        <title><?php echo $_SERVER['SERVER_NAME'];?> | Edit writer</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Edit writer - <?php echo "$sdfname"; ?> <?php echo "$sdlname"; ?></h3>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                         <form action="pages/update_writer.php" method="POST">
