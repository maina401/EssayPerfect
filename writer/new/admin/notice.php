...
<head>
        ...
        <title><?php echo $_SERVER['SERVER_NAME'];?> | Manage Notifications</title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="notice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th-list"></span><p>Notifications</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Notifications</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Notifications</a></li>
                                            </ul>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
												    <li><a href="edit-notice.php?id='.$row['notice_id'].'">Edit Notifications</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['title']; ?> ?')" <?php print ' href="pages/drop_not.php?id='.$row['notice_id'].'">Drop Notifications</a></li>
                                                </ul>
                                            </div></td>
