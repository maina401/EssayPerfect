...
<head>
        ...
        <title><?php echo $_SERVER['SERVER_NAME'];?> | View Exam</title>
        ...
        <main class="page-content content-wrap container">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="./" class="logo-text"><span><img src="/images/icon_logo.png" alt="" height="76" width="130"></span></a>
                    </div>
            ...
            <div class="horizontal-bar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li><a href="writers.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span><p>writers</p></a></li>
                        ...
                        <li><a href="notice.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-th-list"></span><p>Notifications</p></a></li>
...
}elseif (isset($_GET['content'])&&isset($_GET['order_id'])){
    if ($_GET['content']=='bids') {
...
<head>
    ...
    <title><?php echo $_SERVER['SERVER_NAME']; ?> | Bids</title>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li role="presentation" class="active"><a href="#tabo5" role="tab"
                                                                                      data-toggle="tab">Active bids</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active fade in" id="tabo5">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT a.writer_id as wd, a.*, b.*, c.*
  ...
  FROM writers a 
    ...
    INNER JOIN orders c
     ON b.order_id=c.order_id
        WHERE b.order_id='$order_id' AND b.status='active';
";
                                                    $result = $conn->query($sql);
                                        ...
                                        <tbody>';
										       ...
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a href="/writer/new/admin/view-writer.php?sid=' . $row['wd'] . '">View Writer</a></li>
													<li class="dropdown-submenu"> <a tabindex="-1" href="/writer/new/admin/pages/update_exam.php?order_id='.$row['order_id'].'&param=44&writer_id='.$row['wd'].'">Assign To</a>
    <ul class="dropdown-menu">
    
</li>
                                                    <li><a onclick = "return confirm(\'Drop  '.$row['first_name'].' ?\')"  href="pages/drop_sd.php?id=' . $row['wd'] . '">Drop writer</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        This order has no bids yet. To invite writers, go to <a href="/writer/orderDetails.php?order_id='.$order_id.'" > Order details</a>, then click on auto assign.
                                    </div>';
