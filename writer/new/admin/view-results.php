...
<head>
        ...
        <title><?php echo $_SERVER['SERVER_NAME'];?> | <?php echo "$exam_name" ?> Results</title>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a'; ?> onclick = "return confirm('Reactivate exam for <?php echo $row['writer_name']; ?> ?')" <?php print ' href="pages/re-activate.php?rid='.$row['record_id'].'&eid='.$exam_id.'">Re-activate</a></li>
