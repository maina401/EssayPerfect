...
$query = "SELECT * FROM tbl_users WHERE first_name LIKE '%$keyword%' AND role = 'writer' or last_name LIKE '%$keyword%' AND role = 'writer'";
}
?>
<!DOCTYPE html>
<html>
...
<head>
        ...
        <title><?php echo $_SERVER['SERVER_NAME'];?> | Search "<?php echo strtoupper($keyword); ?>"</title>
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="writers.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span><p>writers</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">writers</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add writers</a></li>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-writer.php?sid='.$row['user_id'].'">Edit writer</a></li>
													<li><a href="view-writer.php?sid='.$row['user_id'].'">View writer</a></li>
