...
<div class="menu-wrap">
    <nav class="profile-menu">
        ...
        <div class="profile-menu-list">
            <a href="../writer/profile.php"><i class="fa fa-user"></i><span>Profile</span></a>
            <a href="../writer/logout.php"><i class="fa fa-sign-out"></i><span>Logout</span></a>
        </div>
    </nav>
    ...
    <div class="page-sidebar sidebar">
        <div class="page-sidebar-inner slimscroll">
            ...
            <ul class="menu accordion-menu">
                <li><a href="/admin/" class="waves-effect waves-button"><span
                ...
                <li class="active"><a href="writers.php" class="waves-effect waves-button"><span
                        ...
                        <p>writers</p></a></li>
                <li><a href="../writer/examinations.php" class="waves-effect waves-button"><span
                ...
                <li><a href="../writer/results.php" class="waves-effect waves-button"><span
                                ...
                                <div class="panel-body">
                                    <div role="tabpanel">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li role="presentation"><a href="#tabo8" role="tab" data-toggle="tab">Financial
                                                    Analysis</a></li>
                                            <li role="presentation"><a href="#tabo9" role="tab" data-toggle="tab">Late
                                                    Orders</a></li>
                                            <li role="presentation"><a href="#tabu1" role="tab" data-toggle="tab">For
                                                    revison</a></li>
                                            <li role="presentation"><a href="#tabu2" role="tab" data-toggle="tab">Awaiting your Approval</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active fade in" id="tabo5">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT * FROM orders WHERE writer_id='unassigned' ORDER BY due_date DESC";
                                        ...
                                        <tbody>';
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($status == "available") {
                                                                ...
                                                                $stl = '<a href="pages/make_sd_in.php?id=' . $row['order_id'] . '">Mark as UNAVAILABLE</a>';
                                                            } else {
                                                                $st = '<p class="text-danger">' . $row['state'] . '</p>';
                                                                $stl = '<a href="pages/make_sd_ac.php?id=' . $row['order_id'] . '">Mark as AVAILABLE</a>';
                                                            }
                                                            print '
										       <tr>
                                                <td>' . $row['order_id'] . ' </td>
												...
												<td>' . $row['order_total'] * 0.5 . '</td>
												<td>' . $row['order_total'] * 0.41 . '</td>
                                        ...
                                        Nothing was found in database.
                                            ...
                                            <div role="tabpanel" class="tab-pane  fade in" id="tabo6">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT * FROM orders WHERE state='progress' ORDER BY due_date ASC";
                                                    $result = $conn->query($sql);
                                        ...
                                        Nothing was found in database.
                                            ...
                                            <div role="tabpanel" class="tab-pane fade in" id="tabo7">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT * FROM orders WHERE state='completed' ORDER BY due_date DESC";
                                                    $result = $conn->query($sql);
                                        ...
                                        <tbody>';
										       ...
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>' . $stl . '</li>
													<li><a href="/writer/orderDetails.php?order_id=' . $row['order_id'] . '">View Order Details</a></li>
													<li><a href="/writer/new/admin/edit-exam.php?order_id=' . $row['order_id'] . '">Edit these figures</a></li>
                                        ...
                                        Nothing was found in database.
                                            ...
                                            <div role="tabpanel" class="tab-pane fade in" id="tabo9">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT writers.*, orders.*  FROM writers INNER JOIN  orders ON orders.writer_id=writers.writer_id WHERE orders.due_date<CURRENT_TIMESTAMP   AND orders.state<>'completed' ORDER BY due_date DESC";
                                                    $result = $conn->query($sql);
                                        ...
                                        <tbody>';
										       ...
										       <tr>
												...
												<td><div class="alert alert-danger" >' .date('M j Y g:i A', strtotime($row['due_date'] )). '</div></td>
                                                <td>+' . $row['phone'].'</td>
                                                <td>' . $row['pages'] . '</td>
                                                <td>' . $row['order_total'] . '</td>
                                        ...
                                        Nothing was found in database.
                                            ...
                                            <div role="tabpanel" class="tab-pane fade in" id="tabu1">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT writers.*, orders.*  FROM writers INNER JOIN  orders ON orders.writer_id=writers.writer_id  WHERE orders.state='revision' ORDER BY due_date DESC";
                                                    $result = $conn->query($sql);
                                        ...
                                        Nothing was found in database.
                                            ...
                                            <div role="tabpanel" class="tab-pane fade in" id="tabu2">
                                                <div class="table-responsive">
                                                    <?php
                                                    $conn = getConnection();
                                                    $sql = "SELECT writers.*, orders.*  FROM writers INNER JOIN  orders ON orders.writer_id=writers.writer_id  WHERE orders.state='pending' ORDER BY due_date DESC";
                                                    $result = $conn->query($sql);
                                        ...
                                        <tbody>';
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($status == "pending") {
                                                                ...
                                                                $stl = '<a href="pages/make_sd_in.php?id=' . $row['order_id'] . '&param=59">Mark as COMPLETE</a>';
                                                            } else {
                                                                $st = '<p class="text-danger">' . $row['state'] . '</p>';
                                                                $stl = '<a href="pages/make_sd_ac.php?id=' . $row['order_id'] . '">DISPUTE order</a>';
                                                            }
                                                            print '
										       <tr>
                                                <td>' . $row['order_id'] . ' </td>
                                        ...
                                        Nothing was found in database.
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="tab6">
                                                <form action="pages/add_writer.php" method="POST">
