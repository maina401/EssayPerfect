...
<head>
        ...
        <title>Writer Recruitment | Admin Dashboard</title>
        
        <meta content="width=device-width, initial-scale=1" name="viewport"/>
        <meta charset="UTF-8">
        <meta name="description" content="Start Earning from your writings! Register now" />
        <meta name="keywords" content="Writer Registration" />
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="./" class="logo-text"><img src="/images/icon_logo.png" alt="" height="76" width="130"></span></a>
                    </div>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="/writer/new/admin/writers.php" ></a>
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p class="counter"><?php echo number_format($writers); ?></p>
                                        <span class="info-box-title">writers</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-user"></i>
                                    </div>
                            ...
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        ...
                                        <span class="info-box-title">tests</span>
                                    </div>
                                    <div class="info-box-icon">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-white">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p class="counter"><?php echo number_format($banned_writers); ?></p>
                                        <span class="info-box-title">BANNED writerS</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-lock"></i>
                                    </div>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Piechart presentation of writers assessments in FAIL and PASS"
	},
	data: [{
		type: "pie",
		startAngle: 25,
		...
		indexLabel: "{label} - {y}",
		dataPoints: [
			{ y: <?php echo "$std_pass"; ?>, label: "writer Passing Exams" },
			{ y: <?php echo "$std_fails"; ?>, label: "writer Failing Exams" }
