...
$message = "Hellow $myfullname, we received a request for your new password for the <b><?php  echo $_SERVER['SERVER_NAME'];?></b> account, therefore your password have been changed to <br><b style='font-size:20px;color:red;background-color:lightgrey;'>$new_password</b>";
...
$mail->Subject = '<?php echo $_SERVER['SERVER_NAME'];?> Password Reset';
$mail->Body    = $message;
